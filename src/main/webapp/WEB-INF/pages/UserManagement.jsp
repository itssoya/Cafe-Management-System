	...
	<div class="NavBar">
		<form action="${pageContext.request.contextPath}/usermanagement"
			...
			<div class="search-bar">
				<i class="fa-solid fa-magnifying-glass"></i> <input type="text" name="search" value="${search}" placeholder="Search by username or email..."></input>
		...
		<div class="user-registry-container">
			...
			<div class="registryStats">
				...
				<div class="statTotalUser">
					<span class="totalUserLabel">Total Users</span> 
					<span class="total-user-data">${totalUsers}</span>
				</div>

				<div class="stat-verified">
					<span class="verified-label">Verified Users</span> 
					<span class="verified-data">${verifiedUser}</span>
				</div>

				<div class="stat-pending-percentage">
					<span class="pending-percentage-label">Pending Verification</span> <span class="pending-percentage-data">${pendingPercent}</span>
				</div>

				<div class="stat-total-admin">
					<span class="total-admin-label">Admin users</span> <span class="total-admin-data">${totalAdmin}</span>
				</div>
			</div>
						...
						<tr>
							...
							<span class="status"> <c:choose>
										<c:when test="${u.verified == false}">
											<form
												action="${pageContext.request.contextPath}/usermanagement" method="post">
												<input type="hidden" name="action" value="verify"></input> <input type="hidden" name="userId" value="${u.userId}"></input>
							...
							<c:choose>
										...
										<c:when test="${u.admin == true}">
											<form
												action="${pageContext.request.contextPath}/usermanagement"
												method="post">
												<input type="hidden" name="action" value="removeAdmin" /> <input
													type="hidden" name="userId" value="${u.userId}" />

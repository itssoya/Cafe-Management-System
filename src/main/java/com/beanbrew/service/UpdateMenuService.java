...
import com.beanbrew.dao.UpdateMenuDAO;
...
public class UpdateMenuService {
    ...
    public void updateItem (MenuItem item,Part imagePart) {
        ...
        try {
            ...
            UpdateMenuDAO updateDAO = new UpdateMenuDAO();

            boolean success = updateDAO.updateItem(item);
